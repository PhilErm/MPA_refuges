...
simulation.name <- "log_mig_adamtarg_ovr00_fishfav_sens_q01tdam"
...
# Parameters
dep.Kt <- 0.1 # Fractional depletion rate per trawl pass for targeted species
rep.Kt <- 0.2 # Intrinsic recovery rate of habitat for targeted species

dep.K <- 0.1 # Fractional depletion rate per trawl pass for non-targeted species
