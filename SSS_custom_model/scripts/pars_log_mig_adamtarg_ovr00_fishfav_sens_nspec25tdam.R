...
simulation.name <- "log_mig_adamtarg_ovr00_fishfav_sens_nspec25tdam"
n.sims <- 50 # Number of simulations
n.time <- 150 # Length of simulations
n.species <- 25 # Number of species drawn from each class
...
overlap <- 0 # Overlap must be in 5ths if 10 patches and 50% proportion present etc.
...
random.overlap <- 0 # Proportion of overlap non-targeted species have with fishery
...
dep.K <- 0.2 # Fractional depletion rate per trawl pass for non-targeted species
rep.K <- 0.2 # Intrinsic recovery rate of habitat for non-targeted species
