...
simulation.name <- "log_mig_adamtarg_ovr00_fishfav_sens_r03tdam"
...
rep.Kt <- 0.3 # Intrinsic recovery rate of habitat for targeted species

dep.K <- 0.2 # Fractional depletion rate per trawl pass for non-targeted species
rep.K <- 0.3 # Intrinsic recovery rate of habitat for non-targeted species
