...
simulation.name <- "log_mig_adamtarg_ovr00_fishfav_sens_q03tdam"
...
# Parameters
dep.Kt <- 0.3 # Fractional depletion rate per trawl pass for targeted species
rep.Kt <- 0.2 # Intrinsic recovery rate of habitat for targeted species

dep.K <- 0.3 # Fractional depletion rate per trawl pass for non-targeted species
