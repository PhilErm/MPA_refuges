...
simulation.name <- "short_test"
n.sims <- 1 # Number of simulations
n.time <- 5 # Length of simulations
n.species <- 2 # Number of species drawn from each class
n.patches <- 2 # Number of patches in seascape
n.catch.ints <- 1 # Number of catch intervals to explore
...
habitat.mean <- 0
habitat.sd <- 1
habitat.correlation <- 0

# Option 5 parameterisation
overlap <- 1 # Overlap must be in 5ths if 10 patches and 50% proportion present etc.
...
random.overlap <- 0.5 # Proportion of overlap non-targeted species have with fishery
...
# Parameters
dep.K <- 0 # Fractional depletion rate per trawl pass
rep.K <- 0 # Intrinsic recovery rate of habitat

dep.Kt <- 0 # Fractional depletion rate per trawl pass
rep.Kt <- 0 # Intrinsic recovery rate of habitat
