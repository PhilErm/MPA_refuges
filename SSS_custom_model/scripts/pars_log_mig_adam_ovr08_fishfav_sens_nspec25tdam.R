...
simulation.name <- "log_mig_adam_ovr08_fishfav_sens_nspec25tdam"
...
overlap <- 0.8 # Overlap must be in 5ths if 10 patches and 50% proportion present etc.
...
random.overlap <- 0.8 # Proportion of overlap non-targeted species have with fishery
